...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/api/app-update-controller': { kind: 'none', reason: 'The updater is Host and browser state and registers no prompt, tool, or session event.' },
  'packages/api/mcp-controller': { kind: 'none', reason: 'The MCP configuration API is Host and browser state and registers no prompt, tool, or session event.' },
