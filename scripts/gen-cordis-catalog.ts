...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  mcpStatus: 'not a Cordis Service Definition: a root-scoped status store published by mcp-client and read by the MCP controller — packages/mcp/mcp-client/README.md owns the API contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AppUpdateInfoValue: 'typert.md',
  AppUpdateCheckValue: 'typert.md',
  AppUpdateApplyValue: 'typert.md',
  McpServerEntry: 'typert.md',
  McpServersValue: 'typert.md',
  McpServersFileValue: 'typert.md',
  McpStatusValue: 'typert.md',
  McpImportSecretValue: 'typert.md',
  McpValue: 'typert.md',
  McpHeaderOrEnv: 'typert.md',
  McpServerStatus: 'typert.md',
  McpServerToolInfo: 'typert.md',
  McpServerPhase: 'typert.md',
