...
export const th = {
  ...
  'row.runTitle': 'รันปลั๊กอิน Cordis',
  'row.updateTitle': 'อัปเดตปลั๊กอิน Cordis',
  'row.stopTitle': 'หยุดปลั๊กอิน Cordis',
  'row.removeTitle': 'ลบปลั๊กอิน Cordis',
  'purpose.missing': '(ไม่ได้ระบุวัตถุประสงค์)',
  'status.idle': 'พร้อมทำงาน',
  'status.awaitingApproval': 'รอการอนุมัติ',
  'status.failed': 'การรันล้มเหลว',
  'status.clientPending': 'Client พร้อมเปิดใช้งาน',
  'status.running': 'กำลังทำงาน',
  'status.removed': 'ถูกลบออกแล้ว',
  'status.superseded': 'มีการรันที่ใหม่กว่า',
  'run.removed': 'แพ็กเกจนี้ไม่มีอยู่อีกต่อไป',
  'run.superseded': 'มีการ์ดการรันที่ใหม่กว่าอยู่ด้านล่าง',
  'panel.hint': 'การควบคุมการรันอยู่ในแผง Cordis เหนือการตั้งค่า',
  'panel.plugins.aria': 'ปลั๊กอิน Cordis',
  'panel.approvals.aria': 'การอนุมัติ Cordis',
  'panel.trigger': 'Cordis Plugin',
  'panel.runningCount': 'กำลังทำงาน {count}',
  'panel.title': 'ปลั๊กอิน Cordis',
  'panel.empty': 'ยังไม่มีการกำหนดปลั๊กอินใดๆ',
  'panel.loading': 'กำลังอ่าน…',
  'panel.readFailed': 'อ่านรายการปลั๊กอินไม่สำเร็จ: {message}',
  'panel.group.current': 'เซสชันนี้',
  'panel.group.others': 'เซสชันอื่นๆ',
  ...
  'action.approvePlugin': 'อนุญาตเวอร์ชันในอนาคตของปลั๊กอินนี้',
  ...
  'render.failedAbdicated': 'การเรนเดอร์ใน {slot} ล้มเหลว; กู้คืน UI เริ่มต้นแล้ว:',
  'render.failedHeld': 'การเรนเดอร์ใน {slot} ล้มเหลว:',
  'a11y.defining': 'กำลังกำหนดค่าปลั๊กอิน',
  'a11y.failed': 'การกำหนดค่าล้มเหลว',
  'a11y.stopped': 'การกำหนดค่าถูกขัดจังหวะ',
