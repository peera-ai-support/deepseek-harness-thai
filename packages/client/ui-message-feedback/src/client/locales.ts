...
export const th = {
  ...
  'dialog.title': 'ส่งความคิดเห็น',
  'dialog.categories': 'หมวดหมู่ความคิดเห็น',
  'dialog.detail': 'รายละเอียดความคิดเห็น',
  'dialog.hint': 'กรอกรายละเอียดเพื่อช่วยเราปรับปรุงประสบการณ์ เนื้อหาที่ส่งจะรวมบันทึกของบทสนทนานี้',
  'category.task-result': 'ผลลัพธ์ของงาน',
  'category.instruction-following': 'ความเข้าใจและการทำตามคำสั่ง',
  'category.product-interaction': 'ฟังก์ชันและปฏิสัมพันธ์ของผลิตภัณฑ์',
  'category.service-stability': 'ความเสถียรและความเร็ว',
  'category.resource-cost': 'การใช้ทรัพยากรและค่าใช้จ่าย',
  'category.security-privacy-permission': 'ความปลอดภัย ความเป็นส่วนตัว และสิทธิ์',
  'category.other': 'อื่น ๆ',
  'toast.recorded': 'ขอบคุณสำหรับความคิดเห็น',
  ...
  'error.noteTooLarge': 'คำอธิบายยาวเกินไป กรุณาย่อให้สั้นลงแล้วส่งอีกครั้ง',
