...
export const th: { [Key in keyof typeof en]: string } = {
  ...
  deleteTitle: 'ลบ {provider} หรือไม่?',
  deleteDescription: 'การลบ {provider} จะลบการกำหนดค่าออก ข้อมูลประจำตัวที่ใช้งานอยู่จะได้รับการจัดการจากที่อื่นและจะยังคงอยู่',
  deleteDescriptionWithCredential: 'การลบ {provider} จะลบการกำหนดค่าและ API Key ที่บันทึกไว้ออก',
  ...
  savedProvider: 'บันทึก {provider} เรียบร้อยแล้ว',
  credentialConfigured: 'API Key กำหนดค่าแล้ว',
  credentialMissing: 'ไม่มี API Key',
  readOnly: 'เอกสารการตั้งค่าเป็นแบบอ่านอย่างเดียวในการติดตั้งนี้',
  loadFailed: 'โหลดรายชื่อผู้ให้บริการไม่สำเร็จ',
  conflict: 'มีการเปลี่ยนแปลงการตั้งค่านี้จากที่อื่นขณะเปิดการ์ดนี้อยู่ กรุณาปิดแล้วเปิดใหม่เพื่อแก้ไขค่าปัจจุบัน',
  retry: 'ลองใหม่',
  keyInput: 'API Key',
  keyPlaceholder: 'กรอก API Key ของคุณ',
  keyPlaceholderNative: 'กรอก API Key หรือเว้นว่างไว้เพื่อใช้การยืนยันตัวตนจากสภาพแวดล้อม',
  keyStored: 'กำหนดค่าแล้ว — กรอกค่าใหม่เพื่อแทนที่',
  keyEnvLocked: 'ได้จากสภาพแวดล้อมระบบ (อ่านอย่างเดียว)',
  customized: 'การตั้งค่าแบบกำหนดเอง',
  baseUrl: 'Base URL',
  baseUrlDefault: 'ค่าเริ่มต้นของผู้ให้บริการ',
  models: 'โมเดล',
  modelsInherited: 'ใช้ค่าเริ่มต้นของอะแดปเตอร์',
  modelsCustomized: 'แคตตาล็อกโมเดลแบบกำหนดเอง',
  resetModels: 'คืนค่าเริ่มต้น',
  model: 'โมเดล',
  modelId: 'Model ID',
  modelName: 'ชื่อที่แสดง',
  modelNamePlaceholder: 'ใช้ Model ID เมื่อเว้นว่าง',
  contextWindow: 'Context Window',
  ...
  addModel: 'เพิ่มโมเดล',
  removeModel: 'ลบโมเดล',
  modelsEmpty: 'จะไม่แสดงโมเดลในเมนูเลือก ID ที่ไม่อยู่ในรายการยังสามารถส่งได้โดยตรง',
  keyBlank: 'กรอก API Key หรือเว้นว่างเพื่อใช้คีย์เดิมที่บันทึกไว้',
  keyBlankNew: 'กรอก API Key หรือเว้นว่างหากผู้ให้บริการนี้ยืนยันตัวตนด้วยวิธีอื่น',
  keyIllegalCharacters: 'รูปแบบ API Key ไม่ถูกต้อง กรุณาตรวจสอบ',
  modelIdRequired: 'ต้องระบุ Model ID',
  modelIdDuplicate: 'Model ID ต้องไม่ซ้ำกัน',
  modelNameInvalid: 'ชื่อที่แสดงต้องไม่เว้นว่าง',
  modelContextInvalid: 'Context Window ต้องเป็นตัวเลขบวก เช่น 131072, 256K หรือ 1M',
  modelMaxTokensInvalid: 'Max Output Tokens ต้องเป็นตัวเลขบวก เช่น 8192, 64K หรือ 1M',
  advancedHint: 'ฟิลด์อื่นๆ อยู่ใน settings.yaml สามารถแก้ไขได้โดยตรง',
  modelCapacityInvalid: 'ความจุต้องเป็นตัวเลข โดยอาจต่อท้ายด้วย K หรือ M ได้',
  modelDuplicate: 'แต่ละ Model ID ปรากฏได้เพียงครั้งเดียว',
  modelContextWindow: 'Context Window',
  modelMaxTokens: 'Max Output Tokens',
  modelImageSupport: 'รองรับรูปภาพ',
  fetchModels: 'ดึงรายชื่อโมเดลที่พร้อมใช้งาน',
  fetching: 'กำลังสอบถามผู้ให้บริการ\u2026',
  fetchNeedsBaseUrl: 'กรุณากรอก Base URL ก่อน แล้วจึงดึงข้อมูล',
  fetchEmpty: 'ผู้ให้บริการไม่ได้แสดงรายการโมเดลใดๆ กรุณาเพิ่มด้วยตนเอง',
  fetchTitle: 'เลือกโมเดลที่จะเพิ่ม',
  fetchDescription: 'นี่คือโมเดลที่ผู้ให้บริการนี้มีให้เลือก เลือกโมเดลที่ต้องการเพิ่ม',
  fetchSelectAll: 'เลือกทั้งหมด',
  fetchDeselectAll: 'ยกเลิกการเลือกทั้งหมด',
  fetchAdopt: 'เพิ่มรายการที่เลือก',
  customAdd: 'เพิ่มผู้ให้บริการแบบกำหนดเอง',
  customTitle: 'ผู้ให้บริการแบบกำหนดเอง',
  customTag: 'กำหนดเอง',
  customRoute: 'Provider ID',
  customRouteHint: 'ตัวระบุพิมพ์เล็ก ขึ้นต้นด้วยตัวอักษร เพื่อใช้ระบุผู้ให้บริการนี้โดยเฉพาะในคำขอและเป็นชื่อ Credential',
  customRouteInvalid: 'ต้องขึ้นต้นด้วยตัวอักษรพิมพ์เล็ก ตามด้วยตัวอักษรพิมพ์เล็ก ตัวเลข และเครื่องหมายขีดคั่น (-)',
  customRouteTaken: 'มีผู้ให้บริการที่ใช้ ID นี้แล้ว',
  customDisplayName: 'ชื่อที่แสดง',
  customApi: 'โปรโตคอล API',
  customApiUnset: 'ยังไม่ได้เลือก',
  customNeedsBaseUrl: 'ผู้ให้บริการแบบกำหนดเองจำเป็นต้องมี Base URL',
  ...
  keyRequired: 'กรุณากรอก API Key เพื่อดำเนินการต่อ',
}
