...
import { mergeTurnRailItems, type LoadedRailItem } from '../src/client/chat/turn-rail-items.ts'

function loadedItem(turn: number, prompt = `p${String(turn)}`, response = `r${String(turn)}`): LoadedRailItem {
