...
export const th = {
  ...
  'chat.turnNavigation.label': 'การนำทางรอบการสนทนา',
  'chat.turnNavigation.jump': 'ข้ามไปยังรอบที่ {turn}',
  'chat.turnNavigation.jumpLoad': 'โหลดประวัติและข้ามไปยังรอบที่ {turn}',
  ...
  'row.think': 'คิด',
  'row.analysis': 'การวิเคราะห์และขั้นตอน',
  'row.failed': 'ล้มเหลว',
