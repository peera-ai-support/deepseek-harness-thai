...
describe('invariant companion', () => {
  ...
  it('client apply provides ctx.locale seeded with the shipped common namespace', async () => {
    ...
    expect(() => (locale as LocaleRuntime).register(COMMON_NS, 'th', {})).toThrow('already has locale')
  })
})
