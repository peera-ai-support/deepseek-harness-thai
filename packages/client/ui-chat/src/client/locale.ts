...
export const th = {
  'view.chat': 'การสนทนา',
  'number.groupSeparator': ',',
  'duration.compactSeconds': '{seconds} เธงเธด',
  'duration.compactMinutes': '{minutes} เธ {seconds} เธงเธด',
  'duration.milliseconds': '{milliseconds} เธกเธดเธฅเธฅเธดเธงเธดเธเธฒเธ—เธต',
  'stats.counts': '{turns} รอบ · {steps} ขั้นตอน',
  'stats.cacheHit': 'แคชฮิต {percent}%',
  'stats.dialog.title': 'เธชเธ–เธดเธ•เธดเธเธญเธเธเธ—เธชเธเธ—เธเธฒ',
  'stats.dialog.usageTitle': 'เธเธฒเธฃเนเธเนเนเธ—เน€เธเธ',
  'stats.dialog.llmTime': 'เน€เธงเธฅเธฒเธ—เธตเนเนเธกเน€เธ”เธฅเนเธเน',
  'stats.dialog.toolTime': 'เน€เธงเธฅเธฒเธ—เธตเนเน€เธฃเธตเธขเธเน€เธเธฃเธทเนเธญเธเธกเธทเธญ',
  'stats.dialog.ttft': 'เนเธ—เน€เธเธเนเธฃเธเน€เธเธฅเธตเนเธข (TTFT)',
  'stats.dialog.speed': 'เธเธงเธฒเธกเน€เธฃเนเธงเน€เธญเธฒเธ•เนเธเธธเธ• (TPS)',
  ...
  'chat.deepDiving': 'เธเธณเธฅเธฑเธเธเธดเธ”เธฅเธถเธ...',
  ...
  'settings.transcript.title': 'เธเธฒเธฃเนเธชเธ”เธเธเธ—เธชเธเธ—เธเธฒ',
  'settings.transcript.description': 'เธเธงเธเธเธธเธกเน€เธเธทเนเธญเธซเธฒเธเธฃเธฐเธเธงเธเธเธฒเธฃเธเธญเธเธฃเธญเธเธ—เธตเนเน€เธชเธฃเนเธเนเธฅเนเธง',
  'settings.transcript.normal': 'เธกเธฒเธ•เธฃเธเธฒเธ',
  'settings.transcript.compact': 'เธเธฐเธ—เธฑเธ”เธฃเธฑเธ”',
  'fileOpen.title': 'เปิดไฟล์ไม่ได้',
  'fileOpen.unknown': 'ไม่สามารถเปิดไฟล์นี้ได้',
  'message.extraBlock': 'บล็อกเนื้อหาเพิ่มเติม',
  'message.systemPrompt': 'เธเธฃเธญเธกเธเนเธฃเธฐเธเธ',
  'message.systemPromptUpdate': 'เธญเธฑเธเน€เธ”เธ•เธเธฃเธญเธกเธเนเธฃเธฐเธเธ',
  ...
  'message.compaction.commandTitle': 'compact',
  'message.think': 'เธเธดเธ”',
  'message.unknownSurface': 'เหตุการณ์ Surface ที่ไม่รู้จัก: {type}',
  'message.unknownBlock': 'บล็อกเนื้อหาที่ไม่รู้จัก',
  'message.turnProcess.toolCalls.one': 'เน€เธฃเธตเธขเธเน€เธเธฃเธทเนเธญเธเธกเธทเธญ {count} เธเธฃเธฑเนเธ',
  'message.turnProcess.toolCalls.other': 'เน€เธฃเธตเธขเธเน€เธเธฃเธทเนเธญเธเธกเธทเธญ {count} เธเธฃเธฑเนเธ',
  'message.turnProcess.messages.one': '{count} เธเนเธญเธเธงเธฒเธก',
  'message.turnProcess.messages.other': '{count} เธเนเธญเธเธงเธฒเธก',
  'message.turnProcess.subagents.one': 'เธเธฑเธเน€เธญเน€เธเธเธ•เน {count} เธ•เธฑเธง',
  'message.turnProcess.subagents.other': 'เธเธฑเธเน€เธญเน€เธเธเธ•เน {count} เธ•เธฑเธง',
  'message.turnProcess.thoughtForAWhile': 'เธเธดเธ”เธญเธขเธนเน',
  'message.turnProcess.separator': ' ยท ',
  ...
  'message.failure.auth': 'เธเธตเธขเน API เนเธกเนเธ–เธนเธเธ•เนเธญเธ',
  ...
  'message.tokensPerSecond': '{tps} tok/s',
  'message.turnUsage.title': 'เธเธฒเธฃเนเธเนเนเธเธฃเธญเธเธเธตเน',
  'message.turnUsage.consumed': 'เนเธเนเนเธ {total}',
  'message.turnUsage.model': 'เธเธนเนเนเธซเนเธเธฃเธดเธเธฒเธฃ / เนเธกเน€เธ”เธฅ',
  'message.turnUsage.cacheHit': 'เนเธเธเธ—เธตเนเธ•เธฃเธ',
  'message.turnUsage.input': 'เธญเธดเธเธเธธเธ•เธ—เธตเนเธขเธฑเธเนเธกเนเนเธเธ',
  'message.turnUsage.cacheRead': 'เธญเนเธฒเธเธเธฒเธเนเธเธ',
  'message.turnUsage.cacheWrite': 'เน€เธเธตเธขเธเธฅเธเนเธเธ',
  'message.turnUsage.output': 'เน€เธญเธฒเธ•เนเธเธธเธ•',
  'message.turnUsage.reasoning': ' (เธฃเธงเธกเธเธฒเธฃเธเธดเธ”เธงเธดเน€เธเธฃเธฒเธฐเธซเน {tokens})',
  'message.turnUsage.count': '{count} เนเธ—เน€เธเธ',
  'message.turnTime.title': 'เน€เธงเธฅเธฒเนเธฅเธฐเธเธงเธฒเธกเน€เธฃเนเธงเธเธญเธเธฃเธญเธเธเธตเน',
  'message.turnTime.duration': 'เน€เธงเธฅเธฒเธฃเธงเธกเธเธญเธเธฃเธญเธเธเธตเน',
  'message.turnTime.speed': 'เธเธงเธฒเธกเน€เธฃเนเธงเน€เธญเธฒเธ•เนเธเธธเธ• (TPS)',
  'message.turnTime.ttft': 'เน€เธงเธฅเธฒเนเธ—เน€เธเธเนเธฃเธ (TTFT)',
  ...
  'clock.md': '{d}/{m}',
  'clock.ymd': '{d}/{m}/{y}',
} satisfies Partial<Record<ChatKey, string>>
