...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('not-a-git-checkout'), message: z.string(), details: z.object({ repoRoot: z.string().optional() }) }),
  z.object({ code: z.literal('git-fetch-failed'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('no-release-tag'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('update-checkout-failed'), message: z.string(), details: z.object({ tag: z.string() }) }),
  z.object({ code: z.literal('update-install-failed'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('update-build-failed'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('mcp-config-parse'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('mcp-config-invalid'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('mcp-file-write-failed'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('mcp-secret-write-failed'), message: z.string(), details: z.object({}) }),
